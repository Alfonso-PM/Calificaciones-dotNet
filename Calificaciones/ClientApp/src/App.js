                ...
                <div className="col-sm-12">
                    <div className="list-group">
                        {estudiantes.map((estudiante) => (
                            <div key={estudiante.id} className="list-group-item list-group-item-action">
                                <h5 className="text-primary">{estudiante.nombre}</h5>
                                <div className="d-flex justify-content-between">
                                    <div>
                                        <p>{estudiante.nombreEstudiante}</p>
                                        <p>Calificacion 1: {estudiante.semestreUno}</p>
                                        <p>Calificacion 2: {estudiante.semestreDos}</p>
                                        <p>Calificacion 3: {estudiante.semestreTres}</p>
                                        {/* Muestra la calificación final */}
                                        <p>Calificacion Final: {calcularCalificacionFinal(estudiante)}</p>
                                    </div>
                                    <div>
                                        <button
                                            type="button"
